...
export default function KegiatanForm({ kegiatan }: { kegiatan?: KegiatanR }) {
  ...
  const namaKegiatan = watch("namaKegiatan");
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>{kegiatan ? namaKegiatan : "Data Kegiatan Baru"}</CardTitle>
      </CardHeader>
      <CardContent>
        <Form
          method="POST"
          onSubmit={handleSubmit}
          className={cn("flex flex-col gap-y-4 max-w-sm")}
        >
          <FormItem>
