...
const routes = {
  ...
  "routes/dashboard+/layanan": {
    id: "routes/dashboard+/layanan",
    parentId: "routes/dashboard+/_layout",
    path: "layanan",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/pendapatan+/create": {
    id: "routes/pendapatan+/create",
    parentId: "routes/pendapatan+/_layout",
    path: "create",
    index: void 0,
    caseSensitive: void 0,
