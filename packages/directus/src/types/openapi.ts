...
export interface paths {
    ...
    "/items/block_hero_files": {
        ...
        /**
         * List Items
         * @description List the block_hero_files items.
         */
        get: operations["readItemsBlockHeroFiles"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new block_hero_files item.
         */
        post: operations["createItemsBlockHeroFiles"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing block_hero_files items.
         */
        delete: operations["deleteItemsBlockHeroFiles"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple block_hero_files items at the same time.
         */
        patch: operations["updateItemsBlockHeroFiles"];
        trace?: never;
    };
    "/items/block_hero_files/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Retrieve an Item
         * @description Retrieve a single block_hero_files item by unique identifier.
         */
        get: operations["readSingleItemsBlockHeroFiles"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing block_hero_files item.
         */
        delete: operations["deleteSingleItemsBlockHeroFiles"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing block_hero_files item.
         */
        patch: operations["updateSingleItemsBlockHeroFiles"];
        trace?: never;
    };
    "/items/block_hero": {
        parameters: {
    ...
    "/items/post_files": {
         ...
         */
        get: operations["readItemsPostFiles"];
        put?: never;
        /**
         * Create an Item
         * @description Create a new post_files item.
         */
        post: operations["createItemsPostFiles"];
        /**
         * Delete Multiple Items
         * @description Delete multiple existing post_files items.
         */
        delete: operations["deleteItemsPostFiles"];
        options?: never;
        head?: never;
        /**
         * Update Multiple Items
         * @description Update multiple post_files items at the same time.
         */
        patch: operations["updateItemsPostFiles"];
        trace?: never;
    };
    "/items/post_files/{id}": {
        parameters: {
         ...
         */
        get: operations["readSingleItemsPostFiles"];
        put?: never;
        post?: never;
        /**
         * Delete an Item
         * @description Delete an existing post_files item.
         */
        delete: operations["deleteSingleItemsPostFiles"];
        options?: never;
        head?: never;
        /**
         * Update an Item
         * @description Update an existing post_files item.
         */
        patch: operations["updateSingleItemsPostFiles"];
        trace?: never;
    };
    "/items/post": {
        parameters: {
...
export interface components {
    schemas: {
        ...
        ItemsPage: {
            ...
            created_by?: (string | components["schemas"]["Users"]) | null;
            /** Format: date-time */
            updated_at?: string | null;
            updated_by?: (string | components["schemas"]["Users"]) | null;
            sort?: number | null;
            blocks?: (number | components["schemas"]["ItemsPageBlocks"])[] | null;
        };
        ItemsBlockHeroFiles: {
            id?: number;
            block_hero_id?: (string | components["schemas"]["ItemsBlockHero"]) | null;
        ...
        ItemsBlockHero: {
            ...
            content?: string | null;
            images?: (number | components["schemas"]["ItemsBlockHeroFiles"])[] | null;
        };
        ItemsBlockRichtext: {
            /** Format: uuid */
            id?: string;
        ...
        ItemsPageBlocks: {
            id?: number;
            page_id?: (string | components["schemas"]["ItemsPage"]) | null;
            item?: (string | components["schemas"]["ItemsBlockHeroFiles"] | components["schemas"]["ItemsBlockHero"] | components["schemas"]["ItemsBlockRichtext"] | components["schemas"]["ItemsBlockMarkdown"])[] | null;
            collection?: string | null;
        };
        ItemsPostBlocks: {
            id?: number;
            post_id?: (string | components["schemas"]["ItemsPost"]) | null;
            item?: (string | components["schemas"]["ItemsBlockHeroFiles"] | components["schemas"]["ItemsBlockHero"] | components["schemas"]["ItemsBlockRichtext"] | components["schemas"]["ItemsBlockMarkdown"])[] | null;
            collection?: string | null;
        };
        ItemsPostFiles: {
        ...
        ItemsPost: {
            ...
            images?: (number | components["schemas"]["ItemsPostFiles"])[] | null;
        };
        ItemsCategory: {
            /** Format: uuid */
            id?: string;
...
export interface operations {
    ...
    readItemsBlockHeroFiles: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsBlockHeroFiles"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsBlockHeroFiles: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsBlockHeroFiles"][] | components["schemas"]["ItemsBlockHeroFiles"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    deleteSingleItemsBlockHeroFiles: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    updateSingleItemsBlockHeroFiles: {
        parameters: {
            query?: {
                /** @description Control what fields are being returned in the object. */
                fields?: components["parameters"]["Fields"];
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsBlockHeroFiles"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    readItemsPostFiles: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["ItemsPostFiles"][];
                        meta?: components["schemas"]["x-metadata"];
                    };
                };
            };
    ...
    createItemsPostFiles: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsPostFiles"][] | components["schemas"]["ItemsPostFiles"];
            };
        };
        responses: {
            /** @description Successful request */
    ...
    updateSingleItemsPostFiles: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ItemsPostFiles"];
            };
        };
        responses: {
            /** @description Successful request */
